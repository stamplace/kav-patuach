...
export default function Driver() {
  return (
    <ProductShell active="driver" badge="ממשק נהג · אני על הקו">
      <div className="grid gap-8 lg:grid-cols-[390px_1fr]">
        ...
        <section className="grid gap-6">
          <div className="relative h-72 overflow-hidden rounded-[2.5rem] border border-emerald-300/20 bg-[#07111f] p-5">
            ...
            <div className="absolute right-8 top-8 rounded-2xl border border-emerald-300/20 bg-black/55 px-4 py-3 text-sm">
              אזור פעילות: גוש דן
            </div>
            <div className="absolute bottom-8 left-8 rounded-2xl border border-amber-300/20 bg-black/55 px-4 py-3 text-sm text-amber-200">
              3 קריאות חדשות
            </div>

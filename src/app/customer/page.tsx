...
export default function Customer() {
  return (
    <ProductShell active="customer" badge="ממשק לקוח · פתיחת קריאה">
      <div className="grid gap-8 lg:grid-cols-[420px_1fr] lg:items-start">
          ...
          <div className="rounded-[2rem] bg-[#07111f] p-5">
            ...
            <div className="mt-8 space-y-4">
              <label className="block">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/30 p-4 text-slate-200">
                  רחוב רבי עקיבא 12, בני ברק
                </div>
              </label>
        ...
        <section className="grid gap-6">
          <div className="relative h-80 overflow-hidden rounded-[2.5rem] border border-emerald-300/20 bg-[#07111f] p-5">
            ...
            <div className="absolute right-10 top-10 rounded-2xl border border-emerald-300/20 bg-black/55 px-4 py-3 text-sm">
              קריאה פתוחה
            </div>
            <div className="absolute bottom-10 left-8 rounded-2xl border border-amber-300/20 bg-black/55 px-4 py-3 text-sm text-amber-200">
              3 נהגים הגיבו
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {offers.map((offer) => (
                <article key={offer.name} className="rounded-3xl border border-white/10 bg-white/[0.05] p-5">
                  ...
                  <p className="font-black text-emerald-300">{offer.eta} ממך</p>
